...
export function LessonView({lesson,onBack,onNext,onExplore,instrument}:{lesson:Lesson;instrument:Instrument;onBack:()=>void;onNext:()=>void;onExplore:(root:string,scaleKey:NonNullable<Lesson['explore']>['scaleKey'])=>void}){
