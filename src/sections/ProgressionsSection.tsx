...
export function ProgressionsSection({instrument,root,scaleKey,progression,onChord,onProgression,onOpenChord,onPractice}:{instrument:Instrument;root:string;scaleKey:ScaleKey;progression:ProgressionItem[];onChord:(chord:ChordRecord)=>void;onProgression:(items:ProgressionItem[])=>void;onOpenChord:(chord:ChordRecord,view:'analysis'|'arpeggios'|'voicings')=>void;onPractice:()=>void}){
