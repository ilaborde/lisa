...
export function ProgressionsSection({instrument,root,scaleKey,progression,onChord,onProgression,onOpenChord}:{instrument:Instrument;root:string;scaleKey:ScaleKey;progression:ProgressionItem[];onChord:(chord:ChordRecord)=>void;onProgression:(items:ProgressionItem[])=>void;onOpenChord:(chord:ChordRecord,view:'analysis'|'voicings')=>void}){
