...
export type ProgressionItem={id:string;chord:ChordRecord;annotation?:string};
...
export function appendProgressionItems(items:readonly ProgressionItem[],newItems:readonly ProgressionItem[]):ProgressionItem[]{return[...items,...newItems]}
