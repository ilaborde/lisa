...
describe('currículo',()=>{
 it('implementa diecisiete lecciones con pasos',()=>{expect(IMPLEMENTED_LESSONS).toHaveLength(17);expect(IMPLEMENTED_LESSONS.every(l=>l.steps.length>0&&l.steps.length<=7)).toBe(true)});
