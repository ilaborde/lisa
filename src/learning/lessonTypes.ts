...
export type ValidationRule={type:'exact';answer:string|string[]}|{type:'interval';from:string;to:string}|{type:'scale-notes';root:string;scaleKey:ScaleKey}|{type:'chord-notes';root:string;quality:ChordQuality}|{type:'harmony-quality';root:string;scaleKey:ScaleKey;degree:number};
